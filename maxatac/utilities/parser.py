...
def get_parser():
    ...
    model_interpreting_parser.add_argument(
        ...
        type=float,
        default=0.1,
        help="Recall level at which to select the classification threshold from the benchmark TSV. Default: 0.1"
    )
    ...
    model_interpreting_parser.add_argument(
        ...
        type=float,
        default=None,
        help="Classification threshold value. Overrides --recall_level selection when provided."
    )
